...
export class ModelChanges1788591040456 implements MigrationInterface {
    name = 'ModelChanges1788591040456'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "stock_unit" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "stock_unit" DROP COLUMN "deletedAt"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "stock_unit" ADD "deletedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "stock_unit" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
