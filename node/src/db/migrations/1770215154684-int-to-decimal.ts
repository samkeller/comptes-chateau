...
export class IntToDecimal1770215154684 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "accounting-line" ALTER COLUMN "solde" TYPE numeric(10,2)`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "accounting-line" ALTER COLUMN "solde" TYPE integer USING ROUND("solde"::numeric)::integer`);
