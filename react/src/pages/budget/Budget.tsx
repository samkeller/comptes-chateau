    ...
    return (
        <PageTemplate pageTitle="Budget">
            ...
            <div className="flex gap-2 w-full">
                ...
                <Card title="Dépenses mensuelles" className="flex-1">
                    ...
                    >
                        ...
                        <Column
                            field="nature.label"
                            header="Nature"
                            body={(v: RecurringExpense) => v.nature ? <ColoredLabel data={v.nature} /> : null}
                        ></Column>
                        <Column
                            field="poste.label"
                            header="Poste"
                            body={(v: RecurringExpense) => v.poste ? <ColoredLabel data={v.poste} /> : null}
                        ></Column>
                        <Column
                            field="solde"
                            header="Montant"
