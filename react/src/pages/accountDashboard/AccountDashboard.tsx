            ...
            {!loading && overview && (
                <div className="flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <Card title="Actions à faire" className="h-full">
                            {overview.operationsToCheckInAccountCount === 0 && overview.assignedKanbanTasksCount === 0 ? (
                                    ...
                                    {overview.operationsToCheckInAccountCount !== 0 && (
                                        <div className="flex justify-between items-start">
                                            ...
                                            <Button
                                                ...
                                                onClick={() => navigate(`/${accountId}/accountChecks`)}
                                                outlined
                                                className="p-button-sm"
                                            />
                                        </div>
                                    )}
                                    {overview.operationsToCheckInAccountCount !== 0 && <Divider className="shrink" />}
